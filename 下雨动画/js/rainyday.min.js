...
RainyDay.prototype.prepareCanvas = function () {
    ...
    return a.style.position = this.options.position, a.style.top = this.options.top, a.style.left = this.options.left, a.width = this.options.width, a.height = this.options.height, this.options.parentElement.appendChild(a), this.enableSizeChange && this.setResizeHandler(), a
    ...
    (e !== a || f !== b) && (this.canvas.width = this.canvas.width, this.canvas.height = this.canvas.height, this.prepareBackground(this.canvas.width, this.canvas.height), this.glass.width = this.canvas.width, this.glass.height = this.canvas.height, this.prepareReflections()), (g !== c || h !== d) && (this.canvas.offsetLeft = c, this.canvas.offsetTop = d)
    ...
    var a = this.r;
    if (this.r = .95 * this.r, this.r < 3)this.context.arc(this.x, this.y, this.r, 0, 2 * Math.PI, !0), this.context.closePath(); else if (this.colliding || this.yspeed > 2) {
        if (this.colliding) {
